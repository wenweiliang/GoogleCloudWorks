...
while read lines; do
	...
	Pair=${LGene}--${RGene}
	LgsPath="gs://dinglab/wliang_fusion/output/all_100kb_2nd_HighPass/${Filename}.${LGene}.txt"
	RgsPath="gs://dinglab/wliang_fusion/output/all_100kb_2nd_HighPass/${Filename}.${RGene}.txt"
